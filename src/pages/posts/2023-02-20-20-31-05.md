...
data.go.jp の API のエンドポイントは ``https://www.data.go.jp/data/api``、祝日.csvのデータセットIDは ``cao_20190522_0002`` であるとき、メタデータの取得は次のような URL で行えます。

```bash
curl "https://www.data.go.jp/data/api/3/action/package_show?id=cao_20190522_0002"
```
